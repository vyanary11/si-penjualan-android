...
import de.hdodenhof.circleimageview.CircleImageView;
 ...
 public class DetailBarangActivity extends AppCompatActivity {
     ...
     private TextView txtNamaBarangg, txtLevelNamaKategorii, txtDetailHargaJuall, txtDetailHargaBelii, txtDetailStokk, hurufDepanUserDetail;
     private CircleImageView fotoUserDetail, fotoUserDetail1;
     BaseUrlApiModel baseUrlApiModel = new BaseUrlApiModel();
     private String baseUrl=baseUrlApiModel.getBaseURL();
     private static final String API_URL = "api/user?api=profile&kd_barang=";
     Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_detail_barang );
         ...
         /*TEXT VIEW*/
         txtNamaBarangg = findViewById( R.id.txtNamaBarang);
         txtLevelNamaKategorii = findViewById( R.id.txtLevelNamaKategori);
         txtDetailHargaJuall = findViewById( R.id.txtDetailHargaJual);
         txtDetailHargaBelii = findViewById( R.id.txtDetailHargaBeli);
         txtDetailStokk = findViewById(R.id.txtDetailStok);
     ...
     public boolean onOptionsItemSelected(MenuItem item) {
         switch (item.getItemId()) {
             ...
             case R.id.icon_edit:
                 ...
                 i.putExtra( "kdBarang",intent.getStringExtra( "kdUser" ) );
                 startActivity(i);
                 return true;
                 ...
                 new Response.Listener<String>() {
                     ...
                     public void onResponse(String response) {
                         try {
                             ...
                             txtNamaBarangg.setText(  userdetail.getString( "nama_depan" )+" "+userdetail.getString( "nama_belakang" ));
                             if(Integer.parseInt( userdetail.getString( "level_user" ) )==0){
                                 txtLevelNamaKategorii.setText("Owner");
                             }else if(Integer.parseInt( userdetail.getString( "level_user" ) )==1){
                                 txtDetailHargaJuall.setText("Kasir");
                             }
                             txtDetailHargaBelii.setText( userdetail.getString( "no_telp" ) );
                             txtDetailStokk.setText(  userdetail.getString( "alamat" )  );
     ...
     private void deleteBarang(String kdBarang){
         StringRequest stringRequest = new StringRequest( Request.Method.GET, baseUrl+"api/user?api=delete&kd_user="+kdBarang,
                 new Response.Listener<String>() {
                     @Override
                     public void onResponse(String response) {
                         try {
                             ...
                             if (kode.equals("1")) {
                                ...
                                startActivity(i);*/
                                 finish();
                                 Toast.makeText(DetailBarangActivity.this, "Berhasil Menghapus User", Toast.LENGTH_SHORT).show();

                             }else{
                                 Toast.makeText(DetailBarangActivity.this, "Gagal Menghapus User", Toast.LENGTH_SHORT).show();
                             }
                         } catch (JSONException e) {
                             e.printStackTrace();
                             Toast.makeText(DetailBarangActivity.this, "Periksa koneksi & coba lagi", Toast.LENGTH_SHORT).show();
