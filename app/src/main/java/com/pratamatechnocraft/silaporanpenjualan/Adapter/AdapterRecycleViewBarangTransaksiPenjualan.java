...
public class AdapterRecycleViewBarangTransaksiPenjualan extends RecyclerView.Adapter<AdapterRecycleViewBarangTransaksiPenjualan.ViewHolder> {

    private List<ListItemBarangTransaksi> listItemBarangTransaksis;
    private Context context;

    public AdapterRecycleViewBarangTransaksiPenjualan(List<ListItemBarangTransaksi> listItemBarangTransaksis, Context context) {
