...
public class AdapterRecycleViewDataUtang extends RecyclerView.Adapter<AdapterRecycleViewDataUtang.ViewHolder> {

    private List<ListItemTransaksi> listItemTransaksis;
    private Context context;

    public AdapterRecycleViewDataUtang(List<ListItemTransaksi> listItemTransaksis, Context context) {
