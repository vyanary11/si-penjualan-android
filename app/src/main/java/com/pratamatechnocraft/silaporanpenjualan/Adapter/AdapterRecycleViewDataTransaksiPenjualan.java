...
public class AdapterRecycleViewDataTransaksiPenjualan extends RecyclerView.Adapter<AdapterRecycleViewDataTransaksiPenjualan.ViewHolder> {

    private List<ListItemTransaksi> listItemTransaksis;
    private Context context;

    public AdapterRecycleViewDataTransaksiPenjualan(List<ListItemTransaksi> listItemTransaksis, Context context) {
